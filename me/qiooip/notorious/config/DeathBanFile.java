...
/*    */   public DeathBanFile()
/*    */   {
/* 19 */     this.file = new File(Notorious.getInstance().getDataFolder(), "deathban.yml");
/* 20 */     if (!this.file.exists()) {
/* 21 */       Notorious.getInstance().saveResource("deathban.yml", false);
/*    */     }
/* 23 */     this.configuration = YamlConfiguration.loadConfiguration(this.file);
/*    */   }
/*    */   
/*    */   public void load() {
/* 27 */     this.file = new File(Notorious.getInstance().getDataFolder(), "deathban.yml");
/* 28 */     if (!this.file.exists()) {
/* 29 */       Notorious.getInstance().saveResource("deathban.yml", false);
/*    */     }
...
/* Location:              C:\Users\leagu\Desktop\Notorious-Mango.jar!\me\qiooip\notorious\config\DeathBanFile.class
