...
/*    */   {
/* 19 */     this.file = new File(Notorious.getInstance().getDataFolder(), "utilities.yml");
/* 20 */     if (!this.file.exists()) {
/* 21 */       Notorious.getInstance().saveResource("utilities.yml", false);
/*    */     }
/* 23 */     this.configuration = YamlConfiguration.loadConfiguration(this.file);
/*    */   }
/*    */   
/*    */   public void load() {
/* 27 */     this.file = new File(Notorious.getInstance().getDataFolder(), "utilities.yml");
/* 28 */     if (!this.file.exists()) {
/* 29 */       Notorious.getInstance().saveResource("utilities.yml", false);
/*    */     }
...
/* Location:              C:\Users\leagu\Desktop\Notorious-Mango.jar!\me\qiooip\notorious\config\UtilitiesFile.class
